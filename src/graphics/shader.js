...
Shader.prototype.shade = function (point, face, viewDirection) {
    ...
    for (let i = 0; i < lightCount; i++) {
        ...
        if (light.type == Light.TYPE.AMBIENT) {
            // Ambient
            redSum += material.ambient[0] * light.red * light.intensity;
            greenSum += material.ambient[1] * light.green * light.intensity;
            blueSum += material.ambient[2] * light.blue * light.intensity;
        } else {
